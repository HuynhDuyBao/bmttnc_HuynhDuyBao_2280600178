...
# List of connected clients (stores tuple of socket and AES key)
clients = []
clients_lock = threading.Lock()  # Lock for thread-safe client list operations
...
try:
    while True:
        ...
        client_thread.daemon = True  # Make thread daemon to exit with main program
        client_thread.start()
